  ...
  return (
    <Card className="w-full max-w-md glass-card border-bloom-dark/10">
      <CardHeader className="text-center">
        <CardTitle className="text-3xl font-serif italic mb-2">Bienvenue</CardTitle>
        <CardDescription className="text-bloom-dark/60">
          Connectez-vous à votre compte Bloom
        </CardDescription>
      </CardHeader>
      ...
      <form onSubmit={handleSubmit}>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                className="text-xs text-bloom-sage hover:text-bloom-accent transition-colors"
              >
                Mot de passe oublié ?
              </Link>
            </div>
        ...
        <CardFooter className="flex flex-col space-y-4">
          ...
          <p className="text-sm text-center text-bloom-dark/60 font-sans">
            ...
            <Link href="/register" className="text-bloom-accent hover:text-bloom-dark transition-colors font-semibold">
              Créer un compte
            </Link>
          </p>
        </CardFooter>
