...
import { useTournament, useUpdateTournament } from '@/features/tournaments/api/use-tournaments'
...
import type { TournamentType, TournamentVisibility, TournamentStatus } from '@/features/tournaments/types'
...
export default function TournamentEditPage({ params }: TournamentEditPageProps) {
  const { id } = use(params)
  const router = useRouter()
  const { data: tournament, isLoading } = useTournament(id)
  const { mutate: updateTournament, isPending, error } = useUpdateTournament()
  ...
  useEffect(() => {
    if (tournament) {
      setFormData({
        ...
        prizePool: parseFloat(tournament.prizePool),
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Update tournament settings</p>
        </div>
      </div>
              ...
              <div className="grid gap-4 md:grid-cols-3">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setFormData((prev) => ({ ...prev, visibility: value as TournamentVisibility }))
                    }
                    disabled={isPending}
                  >
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setFormData((prev) => ({ ...prev, status: value as TournamentStatus }))
                    }
                    disabled={isPending}
                  >
